...
public class Drug extends javax.swing.JFrame {
        ...
        public Drug() {
                ...
                // Add another window listener to handle dispose event
        ...
        private void initComponents() {
                ...
                btnUpdateDrug.setIcon(
                                new javax.swing.ImageIcon(getClass().getResource("/img/CRUD img/update_drug.png"))); // NOI18N
                ...
                btnCancel.setIcon(new javax.swing.ImageIcon(
                                getClass().getResource("/img/CRUD img/icons8-cancel-24.png"))); // NOI18N
                ...
                btnClear.setIcon(
                                new javax.swing.ImageIcon(getClass().getResource("/img/CRUD img/icons8-clear-24.png"))); // NOI18N
                ...
                btnDeleteDrug.setIcon(new javax.swing.ImageIcon(
                                getClass().getResource("/img/CRUD img/no-drugs_8210407.png"))); // NOI18N
                ...
                boxYear.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Year : ", "2016", "2017",
                                "2018",
                ...
                boxMonth.setModel(new javax.swing.DefaultComboBoxModel<>(
                                new String[] { "Month : ", "01", "02", "03", "04", "05", "06", "07", "08", "09", "10",
                                                "11", "12" }));

                boxQuantity.setModel(
                                new javax.swing.DefaultComboBoxModel<>(new String[] { "Quantity : ", "1", "2", "3", "4",
                ...
                txtDrugType.setModel(
                                new javax.swing.DefaultComboBoxModel<>(new String[] { "Drug_Type : ", "Acid Reducer",
                                                "Antibiotic", "Anti-Inflammatory", "Blood Pressure Medic",
                                                "Cholesterol Medication", "Corticosteroid",
                                                "Diabetes Medication", "Diuretic", "Painkiller" }));

                boxExp_day.setModel(
                                new javax.swing.DefaultComboBoxModel<>(new String[] { "Day : ", "01", "02", "03", "04",
        ...
        private void btnAdddrugActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAdddrugActionPerformed
                if (txtDrugName.getText().equals("") || txtDrugType.getSelectedItem().equals("Select Type")
                                || txtDose.getText().equals("")
                                || boxExp_day.getSelectedItem().equals("Select Day")
                                || boxMonth.getSelectedItem().equals("Select Month")
                                || boxYear.getSelectedItem().equals("Select Year")
                                || boxQuantity.getSelectedItem().equals("Select Quantity")
                                || txtSellingPrice.getText().equals("")) {
                        JOptionPane.showMessageDialog(null, "Complete Your Information", "Missing Information", 2);
                } else {
                        try {
                                String sql = "INSERT INTO pharmacy.drugs (NAME, TYPE, DOSE, SELLING_PRICE, EXPIRATION_DATE, QUANTITY) VALUES (?,?,?,?,?,?)";
                                ...
                                pre.setString(4, txtSellingPrice.getText());

                                String expdate = boxYear.getSelectedItem().toString() + "-"
                                                + boxMonth.getSelectedItem().toString() + "-"
                                                + boxExp_day.getSelectedItem().toString();
                                pre.setString(5, expdate);
                                pre.setString(6, boxQuantity.getSelectedItem().toString());

                                pre.execute();
                                JOptionPane.showMessageDialog(null, "Drug has been Added Successfully", "Success", 1);

                                // Notify other forms that drug data has changed
                                TableUpdateManager.getInstance().notifyTableDataChanged("drugs");
        ...
        private void btnDeleteDrugActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnDeleteDrugActionPerformed
                if (txtDrugID.getText().equals("")) {
                        JOptionPane.showMessageDialog(null, "Enter Drug Name You want to delete", "Missing Information",
                                        2);
                } else {
                        if (checkdrug_name()) {
                                try {
                                        String sql = "DELETE FROM drugs WHERE DRUG_ID=?";
                                        int confirming = JOptionPane.showConfirmDialog(null,
                                                        "Are You Sure You Want to Delete this Drug?");
                                        if (confirming == 0) {
                                                pre = con.prepareStatement(sql);
                                                pre.setString(1, txtDrugID.getText());
                                                pre.execute();
                                ...
                                JOptionPane.showMessageDialog(null, "the Name is not available !", "Error Deletion", 2);
                        }
                }
                ...
                if (txtDrugID.getText().equals("") || txtDrugName.getText().equals("")
                        ...
                        if (checkdrug_name()) {
                                try {
                                        ...
                                        pre.execute();
                                        JOptionPane.showMessageDialog(null, "Drug has been updated Successfully",
                                                        "Success", 1);
                                ...
                                JOptionPane.showMessageDialog(null, "the ID is not available !", "Error Update", 2);
                        }
                }
        ...
        private void btnPrintDrugActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnPrintDrugActionPerformed
                try {
                        ...
                        JOptionPane.showMessageDialog(this, "Please enter a valid numeric Purchase ID.",
                                        "Validation Error",
        ...
        public static void main(String args[]) {
                ...
                try {
                        ...
                        java.util.logging.Logger.getLogger(Drug.class.getName()).log(java.util.logging.Level.SEVERE,
                                        null, ex);
        ...
        public static void generateReport(PreparedStatement preparedStatement) {
                ...
                try {
                        ...
                        JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(
                                        "C:\\Users\\Ahmed\\Desktop\\Pharma\\Pharmacy-Management-System-master\\src\\Reports\\DrugList.jasper");
                        ...
                        try (ResultSet resultSet = preparedStatement.executeQuery()) {
                                ...
                                viewer.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // Set to dispose on close,
                                                                                          // not exit
